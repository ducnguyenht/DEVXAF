...
namespace LoginApp
{
    public partial class Form1 : Form
    {
        ...
        {
            string MyConnection2 = "datasource=50.62.209:77;database=DucTestMySql;username=DucTestMySql;password=123456";
            MySqlConnection MyConn = new MySqlConnection(MyConnection2);
            MySqlCommand MyCommand = new MySqlCommand("select * from AuditTrail;", MyConn);
