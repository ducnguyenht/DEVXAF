...
namespace TestLogXAF.Web
{
    ...
    public partial class TestLogXAFAspNetApplication : WebApplication
    {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private TestLogXAF.Module.TestLogXAFModule module3;
        private DevExpress.ExpressApp.ConditionalAppearance.ConditionalAppearanceModule conditionalAppearanceModule1;
        private DevExpress.ExpressApp.Validation.ValidationModule validationModule1;
        private TestLogXAF.Module.Web.TestLogXAFAspNetModule module4;

        public TestLogXAFAspNetApplication()
        {
            InitializeComponent();
        }
        ...
        private void TestLogXAFAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
            e.Updater.Update();
            e.Handled = true;
#if EASYTEST
