...
{
    public class WebInterfaceViewModels
    {
        ...
        public static IList<WebInterfaceViewModels> MapFromBOs(IList<Image_BO> bos)
        {
            IList<WebInterfaceViewModels> apiObjs = new List<WebInterfaceViewModels>();
            foreach (var bo in bos)
            {
                WebInterfaceViewModels apiObj = new WebInterfaceViewModels();
                apiObj.MapFromBO(bo);
                apiObjs.Add(apiObj);
            }
            return apiObjs;
