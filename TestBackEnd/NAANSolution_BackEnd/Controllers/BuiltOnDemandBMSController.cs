...
namespace NAANSolution_BackEnd.Controllers
{
    ...
    public class BuiltOnDemandBMSController : Controller
    {
        ...
        #region Phần Mềm Quản Lý Tài Liệu Điện Tử
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult ContentManagementSoftwareAdd(ArticleViewModels article)
        {
            if (ModelState.IsValid)
            {
                try
            ...
            return RedirectToAction("ContentManagementSoftware");
        }
        #endregion
