...
<%@ Register Assembly="DevExpress.ExpressApp.Web.v13.2" Namespace="DevExpress.ExpressApp.Web.Controls"
    TagPrefix="cc4" %>
<%@ Register TagPrefix="dx" Namespace="DevExpress.Web.ASPxCallbackPanel" Assembly="DevExpress.Web.v13.2, Version=13.2.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" %>
...
<head runat="server">
    ...
    <script src="http://localhost:4458/signalr/hubs"></script>
     <script type="text/javascript">
        $(function () {
          ...
          // Declare a proxy to reference the hub.
            $.connection.hub.url = "http://localhost:4458/signalr/hubs"
