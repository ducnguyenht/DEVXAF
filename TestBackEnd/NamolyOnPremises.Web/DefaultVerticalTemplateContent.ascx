<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContent.ascx.cs" ClassName="DefaultVerticalTemplateContent" Inherits="NamolyOnPremises.Web.DefaultVerticalTemplateContent" %>
                    ...
                    <td style="vertical-align: top; height: 10px;" class="dxsplPane_<%= BaseXafPage.CurrentTheme %>">
                        <div id="VerticalTemplateHeader" class="VerticalTemplateHeader">
                            <table cellpadding="0" cellspacing="0" border="0" class="Top" width="100%">
                                <tr>
                                    <td class="Logo" style="padding: 0px 0px 0px 0px">
                                        <asp:HyperLink runat="server" NavigateUrl="#" ID="LogoLink">
                                            <cc4:ThemedImageControl ID="TIC" DefaultThemeImageLocation="~/Images" ImageName="namoly.png" Height="60px"
                                ...
                                <td id="LPcell" style="width: 200px; vertical-align: top">
                                    <div id="LP" class="LeftPane">
                                        ...
                                        <cc3:XafUpdatePanel ID="UPTP" runat="server">
                                            ...
                                            <dxrp:ASPxRoundPanel ID="TRP" runat="server" HeaderText="Tools" CssClass="TRP" Width="170px" >
                                                <PanelCollection>
