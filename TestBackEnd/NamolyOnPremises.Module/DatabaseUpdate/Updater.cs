...
//using DevExpress.ExpressApp.Security.Strategy;
//using NamolyOnPremises.Module.BusinessObjects;

namespace NamolyOnPremises.Module.DatabaseUpdate
{
    ...
    public class Updater : ModuleUpdater
    {
        ...
        private void CreateLogin()
        {
            ...
            SecurityApplicationUser defaultEmployeeUserAccount = ObjectSpace.FindObject<SecurityApplicationUser>(new BinaryOperator("UserName", "admin@naansolution.com"));
            if (defaultEmployeeUserAccount == null)
            {
                defaultEmployeeUserAccount = ObjectSpace.CreateObject<SecurityApplicationUser>();
                defaultEmployeeUserAccount.UserName = "admin@naansolution.com";
                defaultEmployeeUserAccount.ExtendedSecurityRoles.Add(adminRole);
                defaultEmployeeUserAccount.SetPassword("a@123456");
            }
