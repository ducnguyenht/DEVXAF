...
namespace CMSModule.Module.BusinessObjects.CMS {
    ...
    public class Article : BaseObject { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (http://documentation.devexpress.com/#Xaf/CustomDocument3146).
        ...
        public string Title
       {
        ...
        [Association("Article-Pictures"),DevExpress.Xpo.Aggregated]
