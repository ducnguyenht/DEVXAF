...
namespace NASDMS.RDS
{
    ...
    {
        static DbProviderFactory factory = DbProviderFactories.GetFactory("MySql.Data.MySqlClient");
        ...
        public int TransactedInsert(string sql, params object[] parms)
        {
            try
            {
                using (var command = CreateCommand(sql + ";SELECT LAST_INSERT_ID();", _connection, parms))
                {
    ...
    public partial class Entity<T> where T : Entity<T>, new()
    {
        ...
        // executes validations and returns a bool result
