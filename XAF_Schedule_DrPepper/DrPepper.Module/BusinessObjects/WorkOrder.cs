...
namespace DrPepper.Module.BusinessObjects
{
    ...
    public class WorkOrder : BaseObject, IEvent, IRecurrentEvent
    {
        ...
        private WorkOrder _RecurrencePattern;
        ...
        public IRecurrentEvent RecurrencePattern
        {
            ...
            set { SetPropertyValue("RecurrencePattern", ref _RecurrencePattern, value as WorkOrder); }
        }
        #endregion
    }
}