...
namespace CMSModule.Module.BusinessObjects.CMS.Galina
{
    ...
    public class Wedding : BaseObject
    {
        public Wedding(Session session)
            : base(session)
        {
        }
        ...
        [Association, DevExpress.Xpo.Aggregated]
        public XPCollection<WeddingAdvice> WeddingAdvices
        {
            get
            {
                return GetCollection<WeddingAdvice>("WeddingAdvices");
            }
        }
    }
}
